...
- AI summaries, titles and canon extraction;
- advanced transcript review in production.
...
`supabase/migrations/20260726210933_secure_public_data_api.sql`.
...
The hosted Central Local reads the reviewed session from
