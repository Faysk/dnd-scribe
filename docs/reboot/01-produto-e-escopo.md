...
- Manter site e Edit em cloud e transcrição pesada no PC. Modernizar a tecnologia do fluxo local que o proprietário confirma funcionar, sem torná-lo apenas temporário. [Divisão vigente](registros/operacao-cloud.md).
...
4. Transcrição pesada, modelos e trabalho operacional continuam locais. Site e Edit usam dados cloud e funcionam com o PC desligado para conteúdo sincronizado; novas transcrições locais exigem o PC ligado.
